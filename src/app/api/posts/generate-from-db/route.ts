...
export async function POST(req: NextRequest) {
    try {
        ...
        // Guard: prevent image-only models (e.g. gpt-image-1, dall-e-3) from being used for
        // text /chat/completions — they'd return 403. Fall back to the provider's text default.
