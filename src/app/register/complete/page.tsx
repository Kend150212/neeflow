    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                borderRadius: '20px', boxShadow: '0 4px 24px rgba(0,0,0,0.08)', overflow: 'hidden',
            }}>
                ...
                <div style={{ padding: '48px 40px' }}>
                    ...
                    {state === 'success' && (
                        <div style={{ textAlign: 'center' }}>
                            ...
                            <p style={{ fontSize: '15px', color: '#71717a', lineHeight: 1.6, margin: '0 0 24px' }}>
                                ...
                                {trialDays > 0 && <> You have a <strong style={{ color: '#7c3aed' }}>{trialDays}-day free trial</strong> — no charge until it ends.</>}
                            </p>
                            ...
                            <div style={{
                                ...
                                <div style={{ display: 'flex', alignItems: 'flex-start', gap: '12px' }}>
                                    ...
                                    <div>
                                        <p style={{ margin: '0 0 2px', fontSize: '11px', color: '#a1a1aa', textTransform: 'uppercase', letterSpacing: '0.8px', fontWeight: 600 }}>Check your email</p>
                                        <p style={{ margin: 0, fontSize: '14px', color: '#18181b', fontWeight: 500 }}>{email}</p>
                                        <p style={{ margin: '4px 0 0', fontSize: '13px', color: '#71717a' }}>We sent a link to set up your password. Check your inbox (and spam folder).</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <button onClick={handleResend} disabled={resendState === 'sending' || resendState === 'sent'}
                                ...
                                {resendState === 'sent' ? (
                                    <><svg width="16" height="16" viewBox="0 0 24 24" fill="none"><path d="M5 13l4 4L19 7" stroke="#15803d" strokeWidth="2.5" strokeLinecap="round" /></svg>Email sent!</>
                                ) : resendState === 'sending' ? 'Sending...' : (
                                    <><svg width="16" height="16" viewBox="0 0 24 24" fill="none"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" stroke="#52525b" strokeWidth="2" /><circle cx="12" cy="12" r="3" stroke="#52525b" strokeWidth="2" /></svg>Resend setup email</>
                                )}
                            </button>
                    ...
                    {state === 'error' && (
                        <div style={{ textAlign: 'center' }}>
                            ...
                            <h1 style={{ fontSize: '22px', fontWeight: 700, color: '#18181b', margin: '0 0 8px' }}>Something went wrong</h1>
                            <p style={{ fontSize: '14px', color: '#71717a', margin: '0 0 24px' }}>
                                We couldn&apos;t verify your payment session. If you completed payment, please check your email or contact support.
                            </p>
